...
<spring:url value="/resources/images/ssr-banar1.png" var="banner"/>
<img src="${banner}"/>
...
<div class="navbar" style="width: 701px;">
    <div class="navbar-inner">
        <ul class="nav">
            ...
            <li style="width: 100px;"><a href="<spring:url value="/tools/Dev-tools.html" htmlEscape="true" />"><i
                    class="icon-wrench"></i> Tools</a></li>
            <li style="width: 140px;"><a href="<spring:url value="/vets.html" htmlEscape="true" />"><i
                    class="icon-th-list"></i> Students</a></li>
